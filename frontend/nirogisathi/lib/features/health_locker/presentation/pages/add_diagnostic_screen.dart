      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildInputField("Hospital/Clinic Name", "Enter name", _hospitalNameController),
            _buildInputField("Date", "DD/MM/YYYY", _dateController),
            _buildInputField("Time", "12:00 Pm", _timeController),
            _buildInputField("Report Type", "e.g. X-Ray, MRI, CT Scan", _reportTypeController),
            _buildInputField("Clinical Notes", "Reason for diagnostic", _clinicalNotesController),
            _buildInputField("Doctor's Notes", "Findings", _doctorNotesController, showPlus: true),
