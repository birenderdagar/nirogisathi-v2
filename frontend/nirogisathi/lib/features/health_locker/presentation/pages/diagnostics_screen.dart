          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                return InkWell(
                  onTap: () => context.push('/health-locker/diagnostic-detail'),
                  borderRadius: BorderRadius.circular(20),
                  child: const DiagnosticCard(),
                );
              },
            ),
          ),
      ...
      child: Row(
        ...
        children: [
          SizedBox(
            ...
            child: Column(
              children: [
                const Text("05", style: TextStyle(fontSize: 26, fontWeight: FontWeight.bold, height: 1.1)),
              ...
              children: [
                ...
                RichText(
                  ...
                  text: const TextSpan(
                    ...
                    children: [TextSpan(text: "Mild congestion observed", style: TextStyle(fontWeight: FontWeight.w500))],
                  ),
                ),
              ],
            ),
