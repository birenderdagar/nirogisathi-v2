...
// Day Planner
import '../../features/home/presentation/providers/day_planner_provider.dart';
import '../../features/home/data/planner_reminder_service.dart';
import '../../features/home/data/datasources/banner_remote_datasource.dart';
import '../../features/home/data/datasources/home_content_remote_datasource.dart';
import '../../features/home/data/datasources/user_subscription_remote_datasource.dart';
import '../../features/health_locker/presentation/providers/health_locker_provider.dart';
...
Future<void> init() async {
  ...
  // ================= DAY PLANNER =================
  getIt.registerLazySingleton<PlannerReminderService>(
    () => PlannerReminderService(),
  );

  getIt.registerLazySingleton<DayPlannerProvider>(
    () => DayPlannerProvider(prefs, getIt<PlannerReminderService>()),
  );
  getIt.registerLazySingleton<HealthLockerProvider>(
    () => HealthLockerProvider(prefs),
  );

  getIt.registerLazySingleton<BannerRemoteDataSource>(
    () => BannerRemoteDataSource(getIt<ApiClient>()),
  );

  getIt.registerLazySingleton<HomeContentRemoteDataSource>(
    () => HomeContentRemoteDataSource(getIt<ApiClient>()),
  );
  getIt.registerLazySingleton<UserSubscriptionRemoteDataSource>(
    () => UserSubscriptionRemoteDataSource(getIt<ApiClient>()),
  );
