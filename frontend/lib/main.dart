...
void main() async {
  ...
  await getIt<PlannerReminderService>().init();
  ...
  runApp(
    ...
    MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider.value(value: getIt<DayPlannerProvider>()),
        ChangeNotifierProvider.value(value: getIt<HealthLockerProvider>()),
      ],
      child: const MyApp(),
    ),
  );
