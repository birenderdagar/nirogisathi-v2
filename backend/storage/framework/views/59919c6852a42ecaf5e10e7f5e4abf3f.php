    ...
    <div class="space-y-7 text-sm">
        ...
        <div>
            ...
            <div class="space-y-2">
                ...
                <a href="<?php echo e(route('current-updates.index')); ?>"
                class="block px-4 py-3 hover:bg-cyan-500 rounded-xl transition">
                📊 Current Updates
                </a>
                ...
                <a href="<?php echo e(route('user-subscriptions.index')); ?>"
                class="block px-4 py-3 hover:bg-cyan-500 rounded-xl transition">
                🧾 User Subscriptions
                </a>
...
</html><?php /**PATH D:\nirogisathi-v3\backend\app\Modules/Admin/Views/dashboard.blade.php ENDPATH**/ ?>